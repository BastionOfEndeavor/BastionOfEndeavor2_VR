...
/var/all_ui_styles = list(
	...
	*/
	"Полночь"    		= 'russian/icons/mob/screen/midnight_ru.dmi',
	"Оранжевый"     	= 'russian/icons/mob/screen/orange_ru.dmi',
	"Ретро"         	= 'russian/icons/mob/screen/old_ru.dmi',
	"Белый"        		= 'russian/icons/mob/screen/white_ru.dmi',
	"Ретро (без рамок)" = 'russian/icons/mob/screen/old-noborder_ru.dmi',
	"Минимализм"   		= 'russian/icons/mob/screen/minimalist_ru.dmi',
	"Голограмма"     	= 'russian/icons/mob/screen/holo_ru.dmi'
...
/var/all_ui_styles_robot = list(
	...
	*/
	"Полночь"    		= 'russian/icons/mob/screen1_robot_ru.dmi',
	"Оранжевый"       	= 'russian/icons/mob/screen1_robot_ru.dmi',
	"Ретро"         	= 'russian/icons/mob/screen1_robot_ru.dmi',
	"Белый"        		= 'russian/icons/mob/screen1_robot_ru.dmi',
	"Ретро (без рамок)" = 'russian/icons/mob/screen1_robot_ru.dmi',
	"Минимализм"   		= 'russian/icons/mob/screen1_robot_minimalist_ru.dmi',
	"Голограмма"    	= 'russian/icons/mob/screen1_robot_minimalist_ru.dmi'
	// End of Bastion of Endeavor Translation
	)
	...
	*/
	...
	if(!ishuman(usr))
		if(!isrobot(usr))
			...
			*/
			to_chat(usr, "<span class='warning'>Для использования этого глагола необходимо быть человеком или роботом.</span>")
			// End of Bastion of Endeavor Translation
			return
