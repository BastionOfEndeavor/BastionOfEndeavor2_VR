...
/datum/category_item/player_setup_item/vore/misc/content(var/mob/user)
	...
	*/
	. += "<b>Отображать в Списке персонажей:</b> <a [pref.show_in_directory ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_show_in_directory=1'><b>[pref.show_in_directory ? "Да" : "Нет"]</b></a><br>"
	. += "<b>Тег Vore в Списке персонажей:</b> <a href='?src=\ref[src];directory_tag=1'><b>[pref.directory_tag]</b></a><br>"
	. += "<b>Тег ERP в Списке персонажей:</b> <a href='?src=\ref[src];directory_erptag=1'><b>[pref.directory_erptag]</b></a><br>"
	. += "<b>Объявление в Списке персонажей:</b> <a href='?src=\ref[src];directory_ad=1'><b>Установить</b></a><br>"
...
/datum/category_item/player_setup_item/vore/misc/OnTopic(var/href, var/list/href_list, var/mob/user)
	if(href_list["toggle_show_in_directory"])
		...
		*/
		var/new_tag = tgui_input_list(user, "Укажите тег Vore в Списке персонажей:", "Тег Vore", GLOB.char_directory_tags, pref.directory_tag)
		// End of Bastion of Endeavor Translation
		if(!new_tag)
			return
		...
		*/
		var/new_erptag = tgui_input_list(user, "Укажите тег ERP в Списке персонажей:", "Тег ERP", GLOB.char_directory_erptags, pref.directory_erptag)
		// End of Bastion of Endeavor Translation
		if(!new_erptag)
			return
