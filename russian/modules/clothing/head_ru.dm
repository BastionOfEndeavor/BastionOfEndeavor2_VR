...
/* Еще один варик, он почти одинаковый, но не одинаковый
/obj/item/clothing/head/collectable/slime
...
/obj/item/clothing/head/hood_vr/hotdog_hood
	...
	desc = "The hood of a hotdog suit, attached to said hotdog suit."
	//case_blueprint_ru = 
...
/obj/item/clothing/head/beret/sec/corporate/officer
	name = "Берет офицера"
	desc = "Чёрный фирменный берет с эмблемой звания офицера. Для офицеров, для которых стиль важнее самой безопасности."
	//case_blueprint_ru = 

/obj/item/clothing/head/beret/sec/corporate/hos
	name = "Берет Главы службы безопасности"
	desc = "Чёрный фирменный берет с эмблемой звания Главы Службы безопасности. Для офицеров, для которых стиль важнее самой безопасности."
	//case_blueprint_ru = 

/obj/item/clothing/head/beret/sec/corporate/warden
	name = "Берет надзирателя"
	desc = "Чёрный фирменный берет с эмблемой звания надзирателя. Для офицеров, для которых стиль важнее самой безопасности."
	//case_blueprint_ru = 
...
/obj/item/clothing/head/beret/sec/gov
	name = "Берет офицера"
	desc = "Чёрный берет с золотой эмблемой."
	//case_blueprint_ru = 
...
/obj/item/clothing/head/surgery/green
	desc = "Шапочка, которую носят хирурги во время операций, чтобы их волосы не щекотали Вам внутренние органы. Эта тёмно-зелёного цвета."
...
/obj/item/clothing/head/greenbandana
	...
	desc = "Зелёная бандана с искусно вышитой полосой."
	//case_blueprint_ru = 
...
/obj/item/clothing/head/cowl
	name = "Чёрный капюшон"
	desc = "Чёрный капюшон с золотым обрамлением. От него отдает культом, но смотрится он стильно."
	//case_blueprint_ru = 
...
/obj/item/clothing/head/welding/fancy
	...
	desc = "Сварочная маска, элегантно расписанная чёрным и золотым цветами."
	//case_blueprint_ru = 
...
/obj/item/clothing/head/santa/green
	...
	desc = "Праздничная шапка, в зелёной вариации!"
	//case_blueprint_ru = 
...
/obj/item/clothing/head/soft/med
	name = "Медицинская кепка"
	desc = "Бейсболка белого цвета с крестом."
	//case_blueprint_ru = 
