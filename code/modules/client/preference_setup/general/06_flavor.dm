...
/datum/category_item/player_setup_item/general/flavor/proc/SetFlavorText(mob/user)
	...
	*/
	...
	HTML += "Введите описание внешности своего персонажа. Скрытые одеждой части тела не будут отображать описание при осмотре Вашего персонажа. Общее описание показывается вне зависимости от одежды. <hr />"
	// End of Bastion of Endeavor Translation
	HTML += "<br></center>"
	/* Bastion of Endeavor Translation
