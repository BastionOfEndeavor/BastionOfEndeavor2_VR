...
/obj/item/clothing/suit/storage/hazardvest
	...
	desc = "Жилет повышенной видимости, используемый на стройке."
	//case_blueprint_ru = 
...
/obj/item/clothing/suit/storage/hazardvest/green
	...
	desc = "Жилет повышенной видимости. Этот зелёного цвета!"
	//case_blueprint_ru = 
...
/obj/item/clothing/suit/storage/toggle/labcoat/red
	...
	desc = "Верхняя одежда, защищающая от воздействия пролитых химикатов. Этот халат красного цвета."
	//case_blueprint_ru = 

/obj/item/clothing/suit/storage/toggle/labcoat/blue
	name = "Синий лабораторный халат"
	desc = "Верхняя одежда, защищающая от воздействия пролитых химикатов. Этот халат синего цвета."
	//case_blueprint_ru = 

/obj/item/clothing/suit/storage/toggle/labcoat/purple
	name = "Фиолетовый лабораторный халат"
	desc = "Верхняя одежда, защищающая от воздействия пролитых химикатов. Этот халат фиолетового цвета."
	//case_blueprint_ru = 

/obj/item/clothing/suit/storage/toggle/labcoat/orange
	name = "Оранжевый лабораторный халат"
	desc = "Верхняя одежда, защищающая от воздействия пролитых химикатов. Этот халат оранжевого цвета."
	//case_blueprint_ru = 

/obj/item/clothing/suit/storage/toggle/labcoat/green
	name = "Зелёный лабораторный халат"
	desc = "Верхняя одежда, защищающая от воздействия пролитых химикатов. Этот халат зелёного цвета."
	//case_blueprint_ru = 

/obj/item/clothing/suit/storage/toggle/labcoat/yellow
	name = "Жёлтый лабораторный халат"
	desc = "Верхняя одежда, защищающая от воздействия пролитых химикатов. Этот халат жёлтого цвета."
	//case_blueprint_ru = 

/obj/item/clothing/suit/storage/toggle/labcoat/pink
	name = "Розовый лабораторный халат"
	desc = "Верхняя одежда, защищающая от воздействия пролитых химикатов. Этот халат розового цвета."
	//case_blueprint_ru = 
...
/obj/item/clothing/suit/stripper/stripper_green
	...
	desc = "Весьма откровенное платье зелёного цвета."
...
/obj/item/clothing/suit/storage/toggle/leather_jacket/nanotrasen/sleeveless
	name = "Кожаная безрукавка"
	desc = "Чёрная кожаная безрукавка. На спине гордо распластан логотип корпорации."
	//case_blueprint_ru = 
...
/obj/item/clothing/suit/chiton
	name = "Хитон"
	desc = "Традиционный элемент одежды из Греции."
	//case_blueprint_ru = 
