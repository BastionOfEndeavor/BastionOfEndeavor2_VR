...
/datum/category_item/player_setup_item/vore/resleeve/content(var/mob/user)
	...
	*/
	. += "<a [pref.resleeve_scan ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_resleeve_scan=1'><b>Добавить запись тела в базу при появлении</b></a><br>"
	. += "<a [pref.resleeve_lock ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_resleeve_lock=1'><b>Запретить несанкционированное клонирование</b></a><br>"
