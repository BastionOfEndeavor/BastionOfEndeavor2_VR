...
/datum/category_item/player_setup_item/vore/vantag/content(var/mob/user)
	...
	*/
	. += "<b>Волонтёрство в эвентах:</b> <a [pref.vantag_volunteer ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_vantag_volunteer=1'><b>[pref.vantag_volunteer ? "Да" : "Нет"]</b></a><br>"
	. += "<b>Роль в эвентах:</b> <a href='?src=\ref[src];change_vantag=1'><b>[vantag_choices_list[pref.vantag_preference]]</b></a><br>"
