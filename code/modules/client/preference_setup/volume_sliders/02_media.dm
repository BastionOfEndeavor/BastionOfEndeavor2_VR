...
/datum/category_item/player_setup_item/volume_sliders/media/content(var/mob/user)
	...
	*/
	...
	. += "<a href='?src=\ref[src];change_media_volume=1'><b>[round(pref.media_volume * 100)]%</b></a><br>"
	. += "<b>Медиаплеер:</b> результаты могут отличаться в зависимости от Вашей операционной системы. "
	. += "По возможности используйте HTML5, но если HTML5 и WMP оба не работают, Вам понадобится использовать VLC, "
