...
/datum/category_item/player_setup_item/player_global/ui/content(var/mob/user)
	...
	*/
	...
	. += "- Альфа (непрозрачность): <a href='?src=\ref[src];select_alpha=1'><b>[pref.UI_style_alpha]</b></a> <a href='?src=\ref[src];reset=alpha'>Сбросить</a><br>"
	...
	. += "<b>Система ввода TGUI:</b> <a href='?src=\ref[src];tgui_input_mode=1'><b>[(pref.tgui_input_mode) ? "Включена" : "Выключена (по умолчанию)"]</b></a><br>"
